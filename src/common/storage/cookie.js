/**
 * Created by Miya on 2017/5/23.
 */

// 存储前缀
import {storagePrefix} from '../config/index.js'

import {toolsVerify, toolsUri} from '../tools/index.js'
...
export default new class Cookie {
  ...
  set (key, value, options) {
    ...
    if (expiresType === 'string' && expires !== '') {
      ...
      expires = new Date(+new Date() + (1000 * expires)) // expires 以秒为单位 在当前时间 expires秒后g
    }
